...
public class UpdateKhachHang extends javax.swing.JDialog {
    ...
    private void displayInfo() {
        a = parent.getKhachHangSelect();
        txtTenKhachHang.setText(a.getHoTenKH());
        txtTenEmail.setText(a.getEmail());
        txtphone.setText(a.getSdt());
    ...
    private void initComponents() {
        ...
        txtTenEmail.setFont(new java.awt.Font("SF Pro Display", 0, 16)); // NOI18N
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                        ...
                                        .addGroup(jPanel1Layout.createSequentialGroup()
                                                ...
                                                .addComponent(jLabel3, javax.swing.GroupLayout.PREFERRED_SIZE, 24,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addGap(6, 6, 6)
                                                .addComponent(txtTenEmail, javax.swing.GroupLayout.PREFERRED_SIZE, 38,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addGap(42, 42, 42)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            String email = txtTenEmail.getText().trim();
            String sdt = txtphone.getText().trim();
            String diaChi = txtDiaChi.getText().trim();
            if (txtTenKhachHang.equals("") || txtTenEmail.equals("") || txtphone.equals("") || txtDiaChi.equals("")) {
                JOptionPane.showMessageDialog(this, "Vui lòng nhập đầy đủ thông tin !", "Cảnh báo",
                        JOptionPane.WARNING_MESSAGE);
            } else {

                // KhachHang kh = new KhachHang();
                // a.setMaKHCode(a.getMaKHCode());
                a.setHoTenKH(tenKH);
                a.setEmail(email);
                a.setSdt(sdt);
                a.setDiaChi(diaChi);
                KhachHangDao.getInstance().update(a);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateKhachHang.class.getName()).log(java.util.logging.Level.SEVERE,
                    null, ex);
