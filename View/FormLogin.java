...
public class FormLogin extends javax.swing.JFrame {
    ...
    public FormLogin() {
        ...
        panClick = new Color(63, 160, 231);
        panEnter = new Color(63, 160, 231);
    ...
    private void initComponents() {
        ...
        jLabel1.setBackground(new java.awt.Color(23, 87, 183));
        jLabel1.setFont(new java.awt.Font("Cantarell", 1, 48)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(23, 87, 183));
        jLabel1.setText("Đăng nhập");
        jPanel2.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 290, 250, 70));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Assets/logo_book.png"))); // NOI18N
        jLabel3.setPreferredSize(new java.awt.Dimension(200, 200));
        jLabel3.setRequestFocusEnabled(false);
        jPanel2.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 130, 280, 170));
        ...
        loginUser.setBackground(new java.awt.Color(23, 87, 183));
        ...
        passwordUser.setBackground(new java.awt.Color(23, 87, 183));
        ...
        jLabel2.setForeground(new java.awt.Color(23, 87, 183));
    ...
    private void jLabel7MouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_jLabel7MouseClicked
        // TODO add your handling code here:
         RecoverMatKhau rcv = new RecoverMatKhau(this, rootPaneCheckingEnabled);
         rcv.setVisible(true);
    ...
    public void checkLogin() {
        ...
        if (usercheck.equals("") || passwordcheck.equals("")) {
            ...
            try {
                NguoiDung acc = NguoiDungDao.getInstance().selectById(usercheck);
                if (acc == null) {
                    ...
                    if (BCrypt.checkpw(passwordcheck, acc.getMatKhau())) {
                        if (acc.getQuyen() != null) {
                            try {
                                String role = acc.getQuyen();
                                JOptionPane.showMessageDialog(null, "Đăng nhập thành công!", "Thông báo",
                                        JOptionPane.INFORMATION_MESSAGE);

                                if (role.equals("Quản Lý")) {
                                    GUIAdmin ad = new GUIAdmin(acc.getTenDangNhap());
                                    ad.setVisible(true);
                                    this.dispose();
                                } else if (role.equals("BanHang")) {
                                    //
                                } else if (role.equals("NhanVienKho")) {
