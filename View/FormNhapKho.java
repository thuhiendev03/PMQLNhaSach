 ...
 * @author TieuSoi
 */
public class FormNhapKho extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        cbxLuaChon.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Tất cả", "Mã sản phẩm",
                "Tên sản phẩm", "Danh mục", "Tác giả", "Nhà xuất bản", "Giá bán nhập", "Nhà cung cấp", " " }));
